...
export function ProductsSection() {
  return (
    <section className="px-5 py-14 sm:py-16 lg:px-[clamp(20px,5vw,72px)] lg:py-28" id="products">
      ...
      <div className="grid gap-3 sm:gap-4 lg:grid-cols-3">
        {productCards.map((feature) => {
          ...
          return (
            <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-[0_18px_42px_rgba(20,58,78,0.06)] transition duration-200 hover:-translate-y-1 hover:border-brand-yellow/70 hover:shadow-[0_24px_54px_rgba(20,58,78,0.1)] sm:min-h-64 sm:p-7" key={feature.title}>
              <Icon className="mb-5 text-brand-blue sm:mb-8" size={28} aria-hidden="true" />
      ...
      <div className="mt-6 grid gap-px overflow-hidden rounded-lg bg-slate-200 sm:mt-8 lg:grid-cols-3" aria-label="Service highlights">
