...
export function ProductGallery() {
  return (
    <section className="bg-white px-5 py-16 lg:px-[clamp(20px,5vw,72px)] lg:py-28" id="gallery">
      ...
      <div className="grid gap-4 lg:grid-cols-4">
        {productGallery.map((item, index) => (
          <article
            ...
            key={item.title}
          >
            <div className={index === 0 ? 'aspect-[4/3] overflow-hidden lg:aspect-[16/11]' : 'aspect-[4/3] overflow-hidden'}>
              <img
